...
(function() {
  var FIRST_FIELD_PATTERN, FIRST_NO_PROCESS_PATTERN, RENDER_COMPLETE_CALLBACK, T, TemplateOutput, VERSION, callbacks, create, escape, getRandomCssClass, hasFunction, init, isArray, isEmpty, isObject, isTemplate, merge, normalize, parseStyles, prepareOutput, processAttributes, processCallbacks, processCssClasses, processFirst, processStyles, registerCallbacks, render, renderAttributes, renderRest, unescape,
  ...
  TemplateOutput = function(template, tags) {
    this.template = template;
    this.tags = tags;
  };

  TemplateOutput.prototype.toString = function() {
    return render(this.tags);
  };
  ...
  init = function(T) {
    ...
    Template.prototype.process = function() {
      ...
      tags = prepareOutput.apply(null, [this.template].concat(__slice.call(data)));
      tags = normalize(tags);
      tags = processAttributes(tags);
      return new TemplateOutput(this, tags);
    };
