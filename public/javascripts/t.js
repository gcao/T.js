...
(function() {
  var FIRST_FIELD_PATTERN, FIRST_NO_PROCESS_PATTERN, T, Template, hasFunction, isArray, isEmpty, isObject, key, merge, normalize, parseStyles, prepareOutput, processAttributes, processCssClasses, processFirst, processStyles, render, renderAttributes, renderRest, value,
  ...
  parseStyles = function(str) {
    var name, part, styles, _i, _len, _ref, _ref1;
    styles = {};
    _ref = str.split(';');
  ...
  renderAttributes = function(attributes) {
    var name, result, s, style, styles;
    result = "";
