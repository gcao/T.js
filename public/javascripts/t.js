...
(function() {
  var FIRST_FIELD_PATTERN, FIRST_NO_PROCESS_PATTERN, RENDERER_CONFIG, RENDER_COMPLETE_CALLBACK, T, VERSION, callbacks, create, escape, getRandomCssClass, hasFunction, init, isArray, isEmpty, isObject, isTemplate, merge, normalize, parseStyles, prepareOutput, processAttributes, processCallbacks, processCssClasses, processFirst, processStyles, registerCallbacks, render, renderAttributes, renderRest, unescape,
  ...
  init = function(T) {
    ...
    Template.prototype.renderWith = function() {
      var config, data, html, output, renderer;
      data = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      config = data.pop();
      output = this.process.apply(this, data);
      html = render(output);
      renderer = config != null ? config[RENDERER_CONFIG] : void 0;
