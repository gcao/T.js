...
T.def 'banner', ->
  [ '.gvreset.gvbanner.BANNER'
    [ '.gvreset.gvbanner-overlay.BANNER_BACKGROUND' ]
    [ '.gvreset.gvbanner-left'
      T('language-switcher').process()
      '&nbsp;&nbsp;'
      t('whose_turn')
      "&nbsp;"
      [ 'img.gvreset.nextPlayerImg.NEXT_PLAYER', src: 'images/default.gif' ]
    ]
...
T.def 'move-number', ->
  [ '.gvreset.gvmove-outer.gvbutton.MOVE_OUTER'
    [ 'a.gvreset.thickbox'
      ...
      '&nbsp;'
      [ 'span.gvreset.gvcontrol-text.CURRENT_MOVE', 0 ]
      '&nbsp;'
      t('move_number_after')
    ]
  ]
...
T.def 'window-opener', ->
  [ 'gvreset.gvopen-window-outer'
    [ 'a'
      ...
      [ 'img.gvreset.gvsprite-newwindow', src: 'images/default.gif' ]
    ]
  ]
...
T.def 'board', ->
  [ '.gvreset.gvboard-outer.gvsprite-21-board'
    [ '.gvreset.gvboard'
      [ '.gvreset.gvboard-overlay.BOARD_POINTS' ]
      [ '.gvreset.gvboard-overlay.BOARD_MARKS' ]
  ...
  [ '.gvreset.gvtoolbar.TOOLBAR'
    [ '.gvreset.gvtb-item.REFRESH'
      [ 'a.gvreset.toggleopacity'
        ...
        [ 'img.gvreset.gvsprite-refresh.REFRESH_IMG', src: 'images/default.gif' ]
      ]
    ]
    [ '.gvreset.gvtb-item.TOGGLE_NUMBER'
      [ 'a.gvreset.toggleopacity'
        ...
        title: "#{t('refresh')} [Alt Shift R]"
        [ 'img.gvreset.gvsprite-refresh.TOGGLE_NUMBER_IMG', src: 'images/shownumber.gif' ]
      ]
    ]
  ]
