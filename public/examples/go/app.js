...
T.def('main', function() {
  return ['.gameviewer', T('banner').process(), T('board').process(), T('toolbar').process(), T('point-label').process(), T('right-panel').process()];
});
...
T.def('banner', function() {
  return [
    ...
    ], T('move-number').process(), T('resign').process(), ['.banner-overlay', T('banner-prisoners').process(), T('window-opener').process()]
  ];
});
...
T.def('move-number', function() {
  return [
    '.move-outer.button', [
      ...
      }, t('move_number_before'), '&nbsp;', ['span.control-text', 0], '&nbsp;', t('move_number_after')
    ]
  ];
});
...
T.def('banner-prisoners', function() {
  return ['.prisoners-outer', T('banner-prisoner', 'black'), T('banner-prisoner', 'white')];
});
...
T.def('board', function() {
  return [
    '.board-outer.sprite-21-board', [
      '.board', ['.board-overlay.points'], ['.board-overlay.marks'], ['.board-overlay.branches'], ['.sprite-21-markmove.move_marks'], ['.board-overlay.prisoners'], [
